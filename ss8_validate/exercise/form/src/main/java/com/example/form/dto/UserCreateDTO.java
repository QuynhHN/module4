...
public class UserCreateDTO implements Validator {
    private Integer id;
    ...
    public UserCreateDTO(Integer id, String firstName, String lastName, String phoneNumber, Integer age, String email) {
        this.id = id;
